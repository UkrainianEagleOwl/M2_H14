...
class Auth:
    ...
    def verify_password(self, plain_password, hashed_password):
        ...
        :param plain_password: Pass the password entered by the user to be verified
    ...
    def create_email_token(self, data: dict):
        ...
        :return: A token that is encoded with the user's email and password
        :doc-author: Trelent
        """
        to_encode = data.copy()
    ...
    async def create_refresh_token(
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass the data that needs to be encoded into the token
        :param expires_delta: Optional[float]: Set the expiration time of the token
        :return: An encoded_refresh_token
        :doc-author: Trelent
        """
        to_encode = data.copy()
        if expires_delta:
